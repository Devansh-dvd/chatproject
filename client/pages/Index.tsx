      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-8 animate-slide-in-up" style={{ animationDelay: '0.2s' }}>
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {/* Channel Card 1 */}
            <div className="p-4 rounded-lg border border-green-500/20 bg-gradient-to-br from-green-500/5 to-transparent backdrop-blur-sm hover:border-green-500/50 transition-all duration-300 group cursor-pointer animate-scale-in" style={{ animationDelay: '0.3s' }}>
            ...
            {/* Channel Card 3 */}
            <div className="p-4 rounded-lg border border-green-500/20 bg-gradient-to-br from-green-500/5 to-transparent backdrop-blur-sm hover:border-green-500/50 transition-all duration-300 group cursor-pointer animate-scale-in" style={{ animationDelay: '0.5s' }}>
            ...
            {/* Channel Card 4 */}
            <div className="p-4 rounded-lg border border-green-500/20 bg-gradient-to-br from-green-500/5 to-transparent backdrop-blur-sm hover:border-green-500/50 transition-all duration-300 group cursor-pointer animate-scale-in" style={{ animationDelay: '0.6s' }}>
            ...
            {/* Channel Card 5 */}
            <div className="p-4 rounded-lg border border-green-500/20 bg-gradient-to-br from-green-500/5 to-transparent backdrop-blur-sm hover:border-green-500/50 transition-all duration-300 group cursor-pointer animate-scale-in" style={{ animationDelay: '0.7s' }}>
        ...
        <div className="mt-12 animate-slide-in-up" style={{ animationDelay: '0.8s' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            {/* Approved Request */}
            <div className="p-4 rounded-lg border border-green-500/30 bg-green-500/5 backdrop-blur-sm animate-scale-in" style={{ animationDelay: '1s' }}>
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-3">
